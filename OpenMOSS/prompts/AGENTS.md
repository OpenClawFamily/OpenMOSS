...
Structured prompts for 4 agent roles. Prompts are markdown files that define WHAT each agent SHOULD DO (their behavior/goals), as opposed to Skills which define HOW (tools/capabilities).
